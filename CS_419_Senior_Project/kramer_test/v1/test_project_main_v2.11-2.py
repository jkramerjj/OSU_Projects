...
def main(stdscr):
    ...
    masterWindow = Windows()
    masterWindow.createMasterWindow(stdscr)
    ...
    while arg != ord('q'):
        ...
        masterWindow.clear(stdscr)
        masterWindow.boarder(stdscr, 0)
        masterWindow.createNewBox(stdscr)
        ...
        stdscr.refresh()
        masterWindow.createNewBox(stdscr)
        masterWindow.createNewBox2(stdscr)
        arg = stdscr.getch()
