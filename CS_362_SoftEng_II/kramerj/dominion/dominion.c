...
int adventurerFunction(int currentPlayer, struct gameState *state )
{
    int cardDrawn;
...
int minionFunction(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos)
{
    int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    {
        case adventurer:
            holder = adventurerFunction(currentPlayer, state);
            return holder;
            
            
        case council_room:
            //+4 Cards
            holder = council_roomFunction(currentPlayer, state, handPos);
            return holder;
        ...
        case village:
            //+1 Card
            holder = villageFunction(currentPlayer, state, handPos);
            return holder;
        ...
        case minion:
            holder = minionFunction(currentPlayer, state, choice1, choice2, handPos);
            return holder;
