...
void playAdventurer(struct gameState *state, int handPos) {
  int currentPlayer = whoseTurn(state);
  int z = 0;
...
void playGreat_Hall(struct gameState *state, int handPos) {
  int currentPlayer = whoseTurn(state);
  //+1 Card
...
void playMinion(struct gameState *state, int handPos, int choice1, int choice2) {
  int currentPlayer = whoseTurn(state);
  int i, j;
...
void playTribute(struct gameState *state) {
  int currentPlayer = whoseTurn(state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case smithy: //iannie - refractored into own function
